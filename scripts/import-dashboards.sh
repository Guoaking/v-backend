...
# 导入核心业务指标仪表板
import_dashboard "$DASHBOARD_DIR/kyc-core-business-dashboard.json" "KYC核心业务指标监控"

# 导入RBAC权限管理监控仪表板
import_dashboard "$DASHBOARD_DIR/kyc-rbac-monitoring-dashboard.json" "RBAC权限管理监控"

# 导入API性能监控仪表板
import_dashboard "$DASHBOARD_DIR/kyc-api-performance-dashboard.json" "API性能监控"

# 导入业务运营分析仪表板
import_dashboard "$DASHBOARD_DIR/kyc-business-operations-dashboard.json" "业务运营分析"
